...
<div class="main-content">
    <div class="section">
        <div class="title-button">
            <h1 class="title">Suas Equipes</h1>
    ...
    <div class="section">
        <div class="title-button">
            <h1 class="title">Seus Campeonatos</h1>
        </div>
        <div class="flex">
            <div class="list-container">
                ...
                {#each campeonatos as campeonato, index (index)}
                    <div
                        class="row-light item"
                        class:row-dark={index % 2 === 0}
                    >
                        <div class="col">
                            {#if campeonato.tipo === "VIRTUAL"}
                                <svg
                                    width="30"
                                    height="33"
                                    viewBox="0 0 36 37"
